  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row placeholders">
			...
			<h4 class="page-header">Clique em uma opção para acessar</h4>
            <div class="col-xs-6 col-sm-12 placeholder">
						
            <a href="mod_denuncias/denuncias.php"  ><img src="img/denuncias.png" width="200" height="200" class="img-responsive" alt="Generic placeholder thumbnail">
              <h4>Denúncias</h4>
