    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
   	  <h1 class="page-header">Alterar Bairro</h1>
		...
		?> 
			<div id="header" > 
	        	...
	        	<?php
			echo' 
				<form action="update_bairros.php?codigo='. $linha['codigo'].'" method="POST" class="header"> 
	    		<div class="margimformadm">
	    					
	   				<center><fieldset style=" width:400px"><table border="0">
					<tr>
					<td width=10%><b>Nome:</b></td>
					<td><input type="text" class="form-control" name="nome"  value="'. $linha["nome"] .'"></td>
					</tr>
				<tr>
				<td><b>Area:</b></td>
				<td><input type="text" class="form-control" name="area"  value="' . $linha["area"] . '"></td>
				</tr>
