    ...
    <body>
        ...
        <div class="row">
          ...
          <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <table style="width:80%" align="center"  cellspacing="15">
             ...
             <tr>
              <td align="center"><?php include 'formulariodebuscabairros.php';?></td> <!-- include formulario de busca -->
              <td align="center"><a href="cadastrarBairro.php">Cadastrar Bairro</a></td>   
            </tr>
          </table>
          <fieldset>
            <?php
            include '../../conexao/conexao.php'; /* include da conexão com o baco de dados */
            $stmt = $conexao->prepare("select codigo,nome,area from bairro where nome like ? LIMIT 10"); 
            if (isset($_GET["nome"])){
              $nome= $_GET["nome"];
             ...
             $stmt = $conexao->query ("select codigo,nome,area from bairro LIMIT 10 ");
           }
          ...
          <table width=100% class="table table-striped">
           <tr> 
             <td width=10%  align="center"><p > '.$linha['codigo'].'</p></th>
              ...
              <td width=10%  align="center"><p > '.$linha['area'].'</p></td>


              <td  width=10% align="center"><a href="#" onclick="show_confirm('.$linha['codigo'].')">Excluir<a></td>
              <td width=10% align="center"><a href="alterarbairro.php?codigo='.$linha['codigo'].'">Alterar<a></td>
      ...
      <script type="text/javascript">
       ...
       function show_confirm(codigo){
         ...
         if(excluir == true){
           window.location.href="deletarbairro.php?codigo=" + codigo +'';
         }else{ 
