      ...
      <div class="row">
		...
		try{
			include "../../conexao/conexao.php";
				$stmt = $conexao->prepare("select codigo_caso,nome,competencia,descricao from caso where codigo_caso = ?");
					$cod_caso= $_GET["codigo_caso"]; 
		...
		?> 
			...
			echo' 
				<form action="update_caso.php?codigo_caso='. $linha['codigo_caso'].'" method="POST" class="header"> 
	    		<div class="margimformadm">
	    					<p class="texte" >Altera Caso</p>
	   						<center><fieldset style=" width:800px">
	   				<table border="0">
								<tr>
									<td>Nome :</td>
									<td><input class="form-control" type="text" name="nome"  value="' . $linha['nome'] . '"></td>
								</tr>
								<tr>
									<td>Competência :</td>
										<td>';	
												$array_teste = array('Vigilância Sanitária','Vigilância Ambiental','Vigilância Epidemiologica'); 
								...
								<tr>
									<td>Descrição :</td>
									<td><textarea class="form-control" name="descricao" required=""  rows="4" cols="50" maxlength="200"> ' . $linha['descricao'] . '</textarea><td>
								</tr>
								<tr>
									<td></td>
