  ...
  <body>
    ...
    <div class="container-fluid">
     ...
     <table style="width:80%" align="center"  cellspacing="15">
      ...
      <?php
        include '../../conexao/conexao.php'; /* include da conexão com o baco de dados */
         $stmt = $conexao->prepare("select codigo_caso,nome,competencia,descricao from caso where nome like ?"); 
        if (isset($_GET["nome"])){
          $nome= $_GET["nome"];
      ...
      echo '
        <table width=100% class="table table-striped">
         <tr> 
           <td width=10%  align="center"><p > '.$linha['codigo_caso'].'</p></th>
            <td width=10%  align="center"><p > '.$linha['nome'].'</p></td>
            <td width=10% align="center"><p >'.$linha['competencia'].' </p></td>
            <td  width=10% align="center"><a href="#" onclick="show_confirm('.$linha['codigo_caso'].')">Excluir <a></td>
            <td width=10% align="center"><a href="alterar_caso.php?codigo_caso='.$linha['codigo_caso'].'">Alterar <a></td>
     ...
     <script type="text/javascript">
          function show_confirm(codigo_caso){
            var excluir = confirm("deseja excluir!");
              if( excluir==true){
                   window.location.href="deletar_caso.php?codigo_caso="+codigo_caso+'';
                }
              }
        </script>
