          ...
          <ul class="nav nav-sidebar">
            <li <?php echoActiveClassIfRequestMatches("denuncias"); ?>><a href="../mod_denuncias/denuncias.php">Denúncias <span class="sr-only">(current)</span></a></li>
					...
					<ul class="nav nav-sidebar">
						...
						<li <?php echoActiveClassIfRequestMatches("casos"); ?>><a href="../geral/casos.php">Casos</a></li>
						<li <?php echoActiveClassIfRequestMatches("bairros"); ?>><a href="../geral/bairros.php">Bairros</a></li>
